...
@section('content')
    ...
    <section class="centro">
        <header class="cabecalho">
            <h1 class="cabecalho-title"><a href="{{ route('homepage') }}">Homepage</a> / <a href="{{ route('cadastros') }}">Cadastros</a> / <a href='{{ route('equipamentos') }}'>Equipamentos</a> / Edição de equipamento</h1></h1>
        ...
        <article class="conteudo">
            <form method="post" action="/updateEquipamento/{{ $exibir->id }}">
                ...
                <div class="container-buttons">
                    ...
                    <a href="{{ route('equipamentos')}}"><button type="button" id="btn-cancelar">Cancelar</button></a>
                </div>
